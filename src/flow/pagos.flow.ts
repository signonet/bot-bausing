 ...
 */
export default BotWhatsapp.addKeyword(['mercado pago','tarjeta', 'visa', 'mastercard','debito','credito'])
    ...
    .addAction(async (ctx, {flowDynamic, state}) => {
        ...
        const paypalLink = "https://qpase.com/pagos"//await generatePaymentLink('10.00', email)
